...
| 日期 | 版本 |
|------|------|
| 2026-09-18 | v2.5.0：新增自定义插件系统与社区插件市场，支持隔离沙箱、在线调试台与插件存储管理，接入 ChatOps 机器人与多渠道通知，默认禁用 API 文档端点并新增 404 页面，优化前端渲染性能 |
| 2026-09-06 | v2.4.0：优化 TOTP 两步验证流程，新增随机时段任务元数据展示，修复多个边界条件与容错问题 |
